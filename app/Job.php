...
class Job extends Model
{
    ...
    public function getnotecount() {
        return $this->hasMany('App\JobsNoteModel', 'job_id', 'id')->count();
    }


    public function jobwelfare()
    {
        return $this->hasMany('App\JobWelfareModel', 'job_id', 'id');
    }


    public function jobteachersaccommodation()
    {
        return $this->hasMany('App\JobTeachersAccommodationModel', 'job_id', 'id');
    }

    public function jobschoolenvironment()
    {
        return $this->hasMany('App\JobSchoolEnvironmentModel', 'job_id', 'id');
    }
    ...
    public function getschooljoin()
    {
        return $this->belongsTo('App\SchoolJoinModel', 'r_school_id', 'id');
    }
    ...
    public function getvisa() {
        return $this->belongsTo('App\VisaModel', 'r_visa_id', 'id');
    }
    ...
    public function getmaxexpectsalary() {
        return $this->belongsTo('App\SalaryExpectModel', 'r_max_salary_id', 'id');
    }

    public function getworkingschedule() {
        return $this->belongsTo('App\WorkingScheduleModel', 'r_working_schedule_id', 'id');
    }
