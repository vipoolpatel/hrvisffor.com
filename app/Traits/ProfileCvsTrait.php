...
trait ProfileCvsTrait
{
    ...
    public function showProfileCvs(Request $request, $user_id)
    {
        ...
        $html = '</br></br><div class="col-mid-12"><table class="table table-bordered table-condensed">';
        if (isset($user) && count($user->profileCvs) > 0):
            $cvCounter = 0;
        ...
        echo $html . '</table></div>';
			...
			// echo "</br></br><strong> If you don't have a CV, you can complete the form below to create it.</strong>";
            echo "";
		endif;
