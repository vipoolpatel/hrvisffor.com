...
trait FetchJobSeekers
{
    ...
    private $fields = array(
        ...
        'users.phone',
        'users.mobile_num',
        'users.country_code_id',
        'users.expectation_working_location',
        'users.tefl_tesol_certificate',
        'users.age_range',
        'users.school_you_prefer',
        'users.students_would_you_like_teach',
        'users.chinese_visa_are_you_holding',
        'users.online_interview',
        'users.anything_else_you_want_to_remark',
    ...
    public function fetchJobSeekers($search = '', $industry_ids = array(), $functional_area_ids = array(), $country_ids = array(), $state_ids = array(), $city_ids = array(), $career_level_ids = array(), $gender_ids = array(), $job_experience_ids = array(), $current_salary = 0, $expected_salary = 0, $salary_currency = '', $position_looking_id = '', $order_by = 'id', $limit = 10)
    {
        $asc_desc = 'DESC';
        ...
        if(!empty($position_looking_id)) {
            $query->where('users.r_position_looking_id', '=', $position_looking_id);    
        }
