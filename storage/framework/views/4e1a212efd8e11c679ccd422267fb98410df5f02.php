        ...
        <div class="row">
            <div class="col-md-12 text-center py-3">
                <div class="titleTop">
                    ...
                    <h3><?php echo e(__('Why Choose')); ?> <span><?php echo e(__('Visffor?')); ?></span></h3>
                </div>
            ...
            <div class="owl-carousel">
                ...
                <div class="item black">
                    <a href="#" class="video" data-video="https://www.youtube.com/embed/FxiskmF16gU" data-toggle="modal" data-target="#videoModal">
                        <img src="<?php echo e(asset('images/home/slider.PNG')); ?>" alt="1" />

                    </a>
                </div>
                <div class="item">
                    <a href="#" class="video" data-video="https://www.youtube.com/embed/FxiskmF16gU" data-toggle="modal" data-target="#videoModal">
                        <img src="<?php echo e(asset('images/home/slider.PNG')); ?>" alt="2" />

                    </a>
                </div>
                <div class="item black">
                    <a href="#" class="video" data-video="https://www.youtube.com/embed/FxiskmF16gU" data-toggle="modal" data-target="#videoModal">
                        <img src="<?php echo e(asset('images/home/slider.PNG')); ?>" alt="3" />

                    </a>
                </div>
                <div class="item">
                    <a href="#" class="video" data-video="https://www.youtube.com/embed/FxiskmF16gU" data-toggle="modal" data-target="#videoModal">
                        <img src="<?php echo e(asset('images/home/slider.PNG')); ?>" alt="4" />
