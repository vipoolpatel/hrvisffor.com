                    ...
                    <div class="owl-carousel2 owl-carousel owl-theme">
                        <div class="item">
                            <div class="beijing-img">
                                <img src="<?php echo e(asset('images/home2/low-angle-photo-of-temple-1581555.png')); ?>">
                        ...
                        <div class="item">
                            <div class="beijing-img">
                                <img src="<?php echo e(asset('images/home2/architecture-building-campus-clark-hall-207684.png')); ?>">
                            <div class="image-grid-clickbox">
                                <div class="beijing-over-text">
                                    <h4 class="beijing-title-slider">Beijing</h4>
                        ...
                        <div class="item"> <div class="beijing-img">
                                <img src="<?php echo e(asset('images/home2/brown-black-and-grey-building-under-cumulus-clouds-207729.png')); ?>">
                            <div class="image-grid-clickbox">
                                <div class="beijing-over-text">
                                    <h4 class="beijing-title-slider">Beijing</h4>
                        ...
                        <div class="item"> <div class="beijing-img"><img src="<?php echo e(asset('images/home2/administration-ancient-architecture-art-208603.png')); ?>">
    ...
    <div class="about-beijing">
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="<?php echo e(asset('images/home2/brown-and-red-temple-2915957.png')); ?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="teach-beijing">
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-md-5">
                    <img src="<?php echo e(asset('images/home2/Frame.png')); ?>" class="img-fluid">
                </div>
    ...
    <div class="teach-beijing">
        ...
        <div class="container-fluid my-4">
            <div class="card-columns">
                <div class="card border-0 text-white"> <img src="<?php echo e(asset('images/home2/10980.png')); ?>" alt="" class="imgal-img">
                ...
                <div class="card border-0 text-white"> <img src="<?php echo e(asset('images/home2/new-york-street-cabs-taxis-8247.png')); ?>" alt="" class="imgal-img">
                    <div class="card-img-overlay p-0">
                        <div class="card-block">
                ...
                <div class="card border-0 text-white"><img src="<?php echo e(asset('images/home2/man-riding-bicycle-on-city-street-310983.png')); ?>" alt="" class="imgal-img">
                    <div class="card-img-overlay p-0">
                        <div class="card-block">
                ...
                <div class="card border-0 text-white"> <img src="<?php echo e(asset('images/home2/apartment-bed-bedroom-chair-271624.png')); ?>" alt="" class="imgal-img">
                    <div class="card-img-overlay p-0">
                        <div class="card-block">
                ...
                <div class="card border-0 text-white"> <img src="<?php echo e(asset('images/home2/architecture-chairs-city-commuter-302428.png')); ?>" alt="" class="imgal-img">
                    <div class="card-img-overlay p-0">
                        <div class="card-block">
