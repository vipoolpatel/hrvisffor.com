...
Route::get('assign-staff-company', array_merge(['uses' => 'Admin\AdminController@AssignCompanyStaff'], $sup_only));
Route::post('get_permission', array_merge(['uses' => 'Admin\AdminController@get_permission'], $sup_only));
Route::post('save_permission', array_merge(['uses' => 'Admin\AdminController@save_permission'], $sup_only));
