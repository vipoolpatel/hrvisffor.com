...
Route::get('user-colour','Admin\UserController@colorUpdate');
...
Route::get('assign-user-staff', array_merge(['uses' => 'Admin\UserController@AssignUserStaff'], $all_users));
...
Route::get('getnote', array_merge(['uses' => 'Admin\UserController@GetNote'], $all_users));
Route::post('add-note', array_merge(['uses' => 'Admin\UserController@AddNote'], $all_users));
Route::get('delete-note', array_merge(['uses' => 'Admin\UserController@DeleteNote'], $all_users));
