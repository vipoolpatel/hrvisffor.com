...
Route::get('my-notification', 'Job\SeekerSendController@all_notification')->name('my.notification');

Route::get('my-updatenotification/{id}', 'Job\SeekerSendController@update_notification')->name('my.updatenotification');
...
Route::get('teacher-interview','TeacherInterviewController@index')->name('teacher.interview');
Route::post('teacher-setup-time','Teacher\TeacherTimeAvailabilityController@store');
Route::get('teacher-setup-time/destroy/{id}','Teacher\TeacherTimeAvailabilityController@destroy');

Route::post('invited-job-reschedule','TeacherInterviewController@storeReschedule');
Route::get('confirmjob-details/{id}','TeacherInterviewController@confirmJobDetails');
Route::get('confirminterview-cancel/{id}','TeacherInterviewController@interviewCancel');
Route::post('confirmjob-reschedule','TeacherInterviewController@storeConfirmReschedule');
