...
Route::get('get_notification_message', 'Admin\HomeController@get_notification_message');
Route::get('get_company_notification_message', 'Admin\HomeController@get_company_notification_message');
