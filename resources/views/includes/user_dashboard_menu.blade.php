<div class="col-lg-3">
    ...
    <ul class="usernavdash">
		...
		<li><a href="{{ route('teacher.interview') }}"><i class="fa fa-calendar"></i> Teacher's Interview</a></li>
		 <li><a href="{{ url('/teacher-job-invitation') }}"><i class="fa fa-paper-plane Blink" aria-hidden="true"></i> Invitation</a></li>
        <li><a href="{{route('my.notification')}}"><i class="fa fa-bell-o" aria-hidden="true"></i> {{__('My Notification')}}</a></li>
		<li><a href="{{route('my.messages')}}"><i class="fa fa-envelope-o" aria-hidden="true"></i> {{__('My Messages')}}</a></li>
        
		{{-- <li><a href="https://chat.hrvisffor.com/signin/{{ Auth::user()->id }}_{{ Auth::user()->email }}_{{ Auth::user()->first_name }}"><i class="fa fa-envelope-o" aria-hidden="true"></i> {{__('Contact Administrator')}}</a>
 --}}
