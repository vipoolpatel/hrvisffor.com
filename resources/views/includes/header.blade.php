                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        <ul class="navbar-nav ml-auto">
                            ...
                            @else
                                <li class="nav-item {{ Request::url() == url('/jobs') ? 'active' : '' }}"><a href="{{url('/jobs'.$teacher_header)}}" class="nav-link">Find a Position</a></li>
                                @if(!empty(Auth::user()->id))
                                @else
                                    <li class="nav-item {{ Request::url() == url('/job-seekers') ? 'active' : '' }}"><a href="{{url('/job-seekers')}}" class="nav-link">Find a Teacher</a></li>
                                @endif
                            ...
                            <li class="nav-item {{ Request::url() == route('faq') ? 'active' : '' }}"><a href="{{ route('faq') }}" class="nav-link">FAQ</a></li>
                           ...
                           <li class="nav-item"><a href="{{url('/job-seekers')}}" class="nav-link">{{__('Seekers')}}</a> </li>--}}
                            ...
                            @endif @if(!Auth::user() && !Auth::guard('company')->user())
                                <li class="nav-item"><a href="{{route('register')}}" class="nav-link regi-btn">{{__('Sign Up')}}</a> </li>
                                <li class="nav-item"><a href="{{route('login')}}" class="nav-link sign-in-btn">{{__('Log in')}}</a> </li>
