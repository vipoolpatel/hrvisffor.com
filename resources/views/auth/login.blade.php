                ...
                <div class="userccount">
                    <div class="userbtns">
                        <ul class="nav nav-tabs">
							...
							{{-- <li class="nav-item"><a class="nav-link {{($c_or_e == 'employer')? 'active':''}}" href="https://chat.hrvisffor.com/" aria-expanded="false">{{__('Employer')}}</a></li> --}}
                    ...
                    <!-- sign up form end-->
                        ...
                        <div id="employer" class="formpanel tab-pane fade {{($c_or_e == 'employer')? 'active':''}}">
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('company.login') }}">
                                ...
                                <div class="formpanel">
                                    <div class="formrow{{ $errors->has('email') ? ' has-error' : '' }}">
                                        <input id="email" type="text" class="form-control" name="email" value="{{ old('email') }}" required autofocus placeholder="{{__('Username')}}">
                                        @if ($errors->has('email'))
                                        <span class="help-block">
                                            <strong>{{ $errors->first('email') }}</strong>
                                        </span>
