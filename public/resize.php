...
define('DIRECTORY_CACHE', 'tmp');  // cache directory
...
define('MAX_FILE_SIZE', 18000000);   // file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)
