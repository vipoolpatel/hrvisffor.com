                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8">
                        ...
                        <div class="candidateinfo">
                            ...
                            <div class="title">School ID: {{$company->school_id}}</div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-8">
                                  {{--   <div class="jobimg"><a href="{{route('job.detail', [$companyJob->slug])}}"
                                    ...
                                    <div class="jobinfo">
                                        <h3><a style="color: #fff;"  href="{{route('job.detail', [$companyJob->slug])}}"
                                                title="{{!empty($companyJob->getpositionlooking->name) ? $companyJob->getpositionlooking->name : ''}}">{{ !empty($companyJob->getpositionlooking->name) ? $companyJob->getpositionlooking->name : '' }}</a></h3>
                                        <div class="companyName"><a style="color: #fff;" href="{{route('company.detail', $company->slug)}}"
                                                title="{{$company->school_id}}">{{$company->school_id}}</a></div>
                                        <div class="location">
                                            <label class="fulltime"
                                                title="{{$companyJob->getLocation()}}">{{$companyJob->getLocation()}}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
