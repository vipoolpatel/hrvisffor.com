    ...
    <div class="row">
        <div class="col-md-12">
            <div class="titleTop text-center">
                ...
                <h3>{{__(' Frequently Asked')}} <span>{{__('Question')}}</span></h3>
            </div>
        </div>
    </div>
        ...
        <ul id="accordion" class="col-sm-6 col-md-12  faq">
            ...
            <li>
                <div id="choose" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" >
                    <span class="faq-img"><img src="{{ asset('images/home/Repeat Grid 6.png') }}"></span><div class="p-1">How to complete profile?</div>
            ...
            <li>
                <div class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    <span class="faq-img"><img src="{{ asset('images/home/Repeat Grid 6.png') }}"></span><div class="p-1"> Where do I go incase I have a complaint?</div>
                    <span class="fa fa-caret-down fa-2x text-faq pull-right"></span>
                </div>
            ...
            <li>
                <div class="collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <span class="faq-img"><img src="{{ asset('images/home/Repeat Grid 6.png') }}"></span><div class="p-1">Do you have any outlets in the country ?</div>
                    <span class="fa fa-caret-down fa-2x text-faq pull-right"></span>
                </div>
            ...
            <li>
                <div class="collapsed" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    <span class="faq-img"><img src="{{ asset('images/home/Repeat Grid 6.png') }}"></span><div class="p-1"> How can I file a complaint?</div>
                    <span class="fa fa-caret-down fa-2x text-faq pull-right"></span>
                </div>
            ...
            <li>
                <div class="collapsed" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                    <span class="faq-img"><img src="{{ asset('images/home/Repeat Grid 6.png') }}"></span><div class="p-1">How can I join the team?</div>
                    <span class="fa fa-caret-down fa-2x text-faq pull-right"></span>
                </div>
            ...
            <li>
                <div class="collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                    <span class="faq-img"><img src="{{ asset('images/home/Repeat Grid 6.png') }}"></span><div class="p-1">In case I forgot my password, what do I do?</div>
                    <span class="fa fa-caret-down fa-2x text-faq pull-right"></span>
                </div>
