                ...
                <div class="tab-list">
                    <nav class="nav-justified ">
                        <div class="nav nav-tabs " id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link" id="pop3-tab" href="{{ url('beijing-profile') }}" role="tab"
                               aria-controls="pop3" aria-selected="false"><i class="fa fa-building"></i> China City
                                Profile</a>
                            <a class="nav-item nav-link" id="pop4-tab" href="{{ route('blogs') }}" role="tab"
                               aria-controls="pop3" aria-selected="false"><i class="fa fa-search-plus"></i>
                                Resources</a>
                            {{--<a class="nav-item nav-link" id="pop5-tab" href="#pop3" role="tab"
                               aria-controls="pop3" aria-selected="false"><i class="fa fa-drivers-license"></i> Live In
                                China</a>--}}
                ...
                <div class="tab-pane fade show active" id="pop1" role="tabpanel" aria-labelledby="pop1-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 mx-auto">
                           ...
                           {{-- <img src="{{ asset('images/home/map.png') }}" class="img-fluid">--}}
                        </div>
                    </div>
                </div>
