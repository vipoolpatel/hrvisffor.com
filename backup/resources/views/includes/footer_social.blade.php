...
<a href="{{ $siteSetting->facebook_address }}" class="facebook" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
@endif
...
<a href="{{ $siteSetting->twitter_address }}" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
@endif
...
<a href="{{ $siteSetting->linkedin_address }}" target="_blank"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
@endif
@if ((string)$siteSetting->youtube_address !== '')
<a href="{{ $siteSetting->youtube_address }}" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a>
@endif
