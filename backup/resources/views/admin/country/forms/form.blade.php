...
<div class="form-group ">
   <label for="is_default" class="bold">Native English?</label>
   <div class="radio-list">
        <select class="form-control" name="is_native">
            <option {{ ($country->is_native == '0') ? 'selected' : '' }} value="0">No</option>
            <option {{ ($country->is_native == '1') ? 'selected' : '' }} value="1">Yes</option>
        </select>
   </div>
</div>
