...
<div class="page-content-wrapper"> 
 ...
 <a href="{{ url('auto-company-login?company_id='.$noti['job']->company_id) }}" title="{{$noti['job']->company_name}}" target="_blank">{{$noti['job']->company_name}}.</a>
                                                     ...
                                                     Current salary ${{$noti['apply']->current_salary}}. Expected salary ${{$noti['apply']->expected_salary}}. Resume: <a target="_blank" href="https://hrvisffor.com/cvs/{{$noti['cv']->cv_file}}">View</a> 
												</div>
                                            </div>
                                        </div>
                                    </div>
