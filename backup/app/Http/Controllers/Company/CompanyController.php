...
class CompanyController extends Controller
{
    ...
    {
        $this->middleware('company', ['except' => ['companyDetail', 'sendContactForm','userProfile']]);
        $this->runCheckPackageValidity();
    }

    public function index()
    {
        $data['jobs'] = Auth::guard('company')->user()->jobs()->paginate(10);
        
        return view('company_home', $data);
    }
    ...
    public function companyProfile()
    {
        ...
        //     $d = Company::find($value->id);
        //     $d->school_id = $value->id.date('dmY');
        //     $d->save();
        // }
