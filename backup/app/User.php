...
class User extends Authenticatable
{
    ...
    public function OnlineUserSeeker() {
        return Cache::has('OnlineUserSeeker' . $this->id);
    }
    ...
    {
        return $this->belongsTo('App\ColourModel', 'r_colour_id', 'id');
    }


// re start
    public function getcurrentlocatioin()
    {
        return $this->belongsTo('App\CurrentLocatioinModel', 'r_current_locatioin_id', 'id');
    }
    ...
    {
        return $this->belongsTo('App\HighestEducationModel', 'r_highest_education_id', 'id');
    }

    public function getpositionlooking() {
        return $this->belongsTo('App\PositionLookingModel', 'r_position_looking_id', 'id');
    }

    public function getworktype() {
        return $this->belongsTo('App\WorkTypeModel', 'r_work_type_id', 'id');
    }

    public function getposition() {
        return $this->belongsTo('App\PositionModel', 'r_position_id', 'id');
    }

    public function getexpectsalary() {
        return $this->belongsTo('App\SalaryExpectModel', 'r_salary_id', 'id');
    }

    public function getexpectsalarymax() {
        return $this->belongsTo('App\SalaryExpectModel', 'r_max_salary_id', 'id');
    }

    public function userschooljoin()
    {
        return $this->hasMany('App\UserSchoolJoinModel', 'user_id', 'id');
    }

    public function userwelfare()
    {
        return $this->hasMany('App\UserWelfareModel', 'user_id', 'id');
    }

    public function userteach()
    {
        return $this->belongsTo('App\TeachModel', 'r_teach_id', 'id');
    }

    public function get_type_chinese_visa()
    {
        return $this->belongsTo('App\TypeChineseVisaModel', 'chinese_visa_are_you_holding', 'id');
    }

    static public function getRuleID()
    {
        $digits = 7;
    ...
    public function getnotecount() {
        return $this->hasMany('App\UsersNoteModel', 'user_id', 'id')->count();
    }
